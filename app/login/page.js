    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12
      ...
      <div className="relative bg-white dark:bg-navy/40 rounded-2xl shadow-sm
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div>
            <label className="block text-sm font-medium text-navy dark:text-cream mb-1">Email</label>
            <input
              type="email"
          ...
          <div>
            <label className="block text-sm font-medium text-navy dark:text-cream mb-1">Password</label>
            <input
              type="password"
